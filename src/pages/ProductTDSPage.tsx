...
const tdsProducts = [
  ...
  {
    category: 'GLASS · WHEEL · LEATHER · FABRIC COATINGS',
    bg: 'var(--color-bg-secondary)',
    bgImg: bgBonus,
    items: [
      {
        brand: 'Magnum',
        name: 'Magnum Glass Armour Pro',
        tagline: 'Hydrophobic glass coating. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Windscreen & side glass' },
          { label: 'Effect', value: 'Hydrophobic — rain beads and sheets off at speed' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'Magnum' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Glass coating', 'Hydrophobic', '1–2 year', 'Magnum'],
        note: 'Hydrophobic glass coating for clearer wet-weather visibility — water clears fast at speed.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'CarPro',
        name: 'CarPro DQUARTZ GForce',
        tagline: 'Hydrophobic glass coating. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Windscreen & side glass' },
          { label: 'Effect', value: 'Strong hydrophobic beading and water release' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'CarPro' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Glass coating', 'Hydrophobic', '1–2 year', 'CarPro'],
        note: 'CarPro’s glass coating — durable rain-repellent finish for the glass.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'Magnum',
        name: 'Magnum Rim Guard Pro',
        tagline: 'Wheel coating — brake dust rinses off. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Wheel faces (barrels on request)' },
          { label: 'Effect', value: 'Repels brake dust & grime; heat resistant' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'Magnum' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Wheel coating', 'Brake-dust resistant', '1–2 year', 'Magnum'],
        note: 'Protects wheel faces and makes baked-on brake dust an easy rinse-off.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'CarPro',
        name: 'CarPro DLUX',
        tagline: 'Wheel & trim coating. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Wheels & plastic trim' },
          { label: 'Effect', value: 'Repels brake dust; restores and protects trim' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'CarPro' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Wheel & trim', 'Brake-dust resistant', '1–2 year', 'CarPro'],
        note: 'CarPro DLUX — a versatile wheel and plastic-trim coating.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'Magnum',
        name: 'Magnum Leather Guard Pro',
        tagline: 'Leather coating — stain & UV protection. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Leather seats & trim' },
          { label: 'Effect', value: 'Stain resistance, UV fade & wear protection' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'Magnum' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Leather coating', 'Stain resistant', 'UV protection', 'Magnum'],
        note: 'Protects leather against stains, UV fade and everyday wear.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'CarPro',
        name: 'CarPro CQUARTZ Leather 2.0 — Leather & Vinyl Coating',
        tagline: 'Leather & vinyl coating. 1–2 Year.',
        warranty: '1–2 Year Durability',
        specs: [
          { label: 'Surface', value: 'Leather & vinyl' },
          { label: 'Effect', value: 'Stain & UV protection; preserves natural texture' },
          { label: 'Durability', value: '1–2 years' },
          { label: 'Backed By', value: 'CarPro' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Leather & vinyl', 'Stain resistant', 'UV protection', 'CarPro'],
        note: 'CarPro CQUARTZ Leather 2.0 — a leather & vinyl coating that keeps the interior protected.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
      {
        brand: 'CarPro',
        name: 'CarPro CQUARTZ Fabric 2.0 — Water & Stain Resistant Coating',
        tagline: 'Fabric coating — water & stain resistant. Up to 12 months.',
        warranty: 'Up to 12 Months',
        specs: [
          { label: 'Surface', value: 'Fabric upholstery & carpets' },
          { label: 'Effect', value: 'Water & stain resistant — spills bead and lift' },
          { label: 'Durability', value: 'Up to 12 months' },
          { label: 'Backed By', value: 'CarPro' },
          { label: 'Full Spec', value: '[Confirm from official TDS]' },
        ],
        features: ['Fabric coating', 'Water resistant', 'Stain resistant', 'CarPro'],
        note: 'CarPro CQUARTZ Fabric 2.0 — water & stain resistance for fabric seats and carpets.',
        link: '/detailing-packages-melbourne',
        linkLabel: 'View Ceramic Packages',
      },
    ],
