...
export default function HomePageWhite() {
  ...
  return (
    <>
      <PageMeta
        title="Glossed Out Detailing — Home (Demo - White)"
        description="Reference version of the home page with a light / white hero."
        canonical="https://glossedoutdetailing.com.au/home-white"
        noindex
      />
