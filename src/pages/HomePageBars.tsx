...
import { Shield, Car, Sparkles, Armchair, Instagram, ArrowRight } from 'lucide-react';
...
export default function HomePageBars() {
  ...
  return (
    <>
      <PageMeta
        title="Glossed Out Detailing — Home (Title Demo 2)"
        description="Reference version of the home page with compact gold service bars."
        canonical="https://glossedoutdetailing.com.au/home-demo2"
        noindex
      />
