...
const faqs = [
  ...
  { q: 'Is ceramic coating worth it in Melbourne?', a: 'Yes — Melbourne\'s UV index and high humidity make ceramic coating particularly valuable. UV causes paint oxidation and fading; ceramic coating\'s UV resistance significantly slows this process. The hydrophobic effect also means bird droppings and industrial fallout are easier to remove before they etch the clear coat.' },
  ...
  { q: 'What ceramic coating products does Glossed Out Detailing use?', a: 'We are Gtechniq, Magnum and Kraken certified and use professional-grade coatings from these ranges depending on the package selected: Gtechniq CSL (Crystal Serum Light) — 5-Year, Magnum Graphene — 7-Year, and Kraken Graphene Titanium — 10-Year self-healing. All are professional-grade products with manufacturer-backed warranty terms. We do not use unbranded or grey-market ceramic products.' },
...
export default function CeramicQuestionsPage() {
  return (
    <>
      <PageMeta
        title="Ceramic Coating Questions — Gtechniq, Magnum & Kraken Certified Melbourne"
        description="Common ceramic coating questions answered by a Gtechniq, Magnum & Kraken certified Melbourne installer."
    ...
    <main style={{ background: 'var(--color-bg-primary)', minHeight: '100dvh' }}>
      <section style={{ padding: '140px var(--section-padding-x) 60px', maxWidth: 780, margin: '0 auto' }}>
        <h1 className="font-display" style={{ fontSize: 'var(--size-h1)', lineHeight: 1, marginBottom: 24 }}>Ceramic Coating — Melbourne Questions</h1>
        <p style={{ color: 'var(--color-text-secondary)', fontSize: 16, lineHeight: 1.75 }}>
          Every common (and uncommon) question about ceramic coating answered honestly. Written by the team at Glossed Out Detailing, a certified installer at Craigieburn, VIC.
        </p>
      ...
      <section style={{ padding: '40px var(--section-padding-x)', maxWidth: 780, margin: '0 auto' }}>
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          <Link to="/ceramic-coating-melbourne" className="btn-primary" style={{ fontSize: 13 }}><span className="btn-slide" /><span>Ceramic Packages &amp; Pricing</span></Link>
          <Link to="/detailing-packages-melbourne" className="btn-ghost" style={{ padding: '10px 20px', fontSize: 13 }}>PPF Q&A</Link>
          <Link to="/detailing-packages-melbourne" className="btn-ghost" style={{ padding: '10px 20px', fontSize: 13 }}>Automotive Tinting Q&A</Link>
        </div>
      </section>
