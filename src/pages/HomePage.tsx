...
const services = [
  {
    ...
    img: '/services/ceramic-1.webp',
    imgs: ['/services/ceramic-1.webp'],
  },
  {
    icon: Car,
    title: 'Car Detailing',
    ...
    img: '/services/detailing-1.webp',
    imgs: [
      '/services/detailing-1.webp', '/services/detailing-2.webp', '/services/detailing-3.webp',
      '/services/detailing-4.webp', '/services/detailing-5.webp', '/services/detailing-6.webp',
      '/services/detailing-7.webp',
    ],
  },
  {
    icon: Sparkles,
  ...
  },
  {
    ...
    href: '/car-detailing-melbourne',
    img: '/services/interior-1.webp',
    imgs: ['/services/interior-1.webp', '/services/interior-2.webp'],
  },
];
    ...
    <>
      ...
      >
        ...
        <div ref={heroContentRef} style={{ position: 'relative', zIndex: 2, maxWidth: 980, padding: '0 24px' }}>
          ...
          <p className="hero-anim hero-sub-shine" style={{ fontSize: 'clamp(34px, 6vw, 62px)', margin: '18px auto 0', lineHeight: 1.1, maxWidth: 760, letterSpacing: 'normal' }}>
