...
import IntroCineHero from './about/IntroCineHero';
...
export default function HomePageIntro() {
  ...
  return (
    <>
      <PageMeta
        title="Glossed Out Detailing — Home (Scroll-scrub intro hero)"
        description="Reference version of the home page with a scroll-scrubbed cinematic intro-video hero."
        canonical="https://glossedoutdetailing.com.au/home-intro"
        noindex
      />
